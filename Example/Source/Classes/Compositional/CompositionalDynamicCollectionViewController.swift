//
//  CompositionalDynamicCollectionViewController.swift
//  Example
//
...
@available(iOS 14.0, *)
class CompositionalDynamicCollectionViewController: UICollectionViewController, FetchedCompositionalDataSourceDelegate {
	private var compositionalDataSource: FetchedCompositionalDataSource<CompositionalDynamicSection, CompositionalItem>?
	private lazy var diffableDataSource: CompositionalDynamicDataSource = {
		CompositionalDynamicDataSource.createDataSource(collectionView: collectionView)
	}()
	...
	private func configureCollectionView() {
		...
		compositionalDataSource = .dynamic(controller: .init(controller: Item.groupedfrc), dataSource: diffableDataSource, delegate: self)
	}
